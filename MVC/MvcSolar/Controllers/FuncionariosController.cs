...
namespace MvcSolar.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public FuncionariosController(MvcSolarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FuncionarioId,UtilizadorId,Email,Nome,Password,LastTimeOnline,Username")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FuncionarioId,UtilizadorId,Email,Nome,Password,LastTimeOnline,Username")] Funcionario funcionario)
        {
